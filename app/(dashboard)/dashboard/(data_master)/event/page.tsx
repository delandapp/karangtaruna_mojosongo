...
import {
  EventCard,
  EventCardData,
} from "@/components/organisms/cards/EventCard";
import { EventFormModal } from "@/components/organisms/modals/event/EventFormModal";
...
export default function EventPage() {
  ...
  const { data, isLoading, isFetching, refetch } = useGetEventsQuery({
    ...
    status_event:
      statusFilter !== "all" ? (statusFilter as StatusEvent) : undefined,
    jenis_event:
      jenisFilter !== "all" ? (jenisFilter as JenisEvent) : undefined,
  });
      ...
      {pages > 1 && (
        <div className="flex items-center justify-between pt-2">
          <p className="text-sm text-muted-foreground">
            ...
            dari <span className="font-medium text-foreground">{pages}</span>
          </p>
