...
import { ProvinsiTable } from "@/components/organisms/tables/master/ProvinsiTable";
...
export default function ProvinsiPage() {
  return (
    <div className="flex flex-col h-full bg-background/50">
      <DashboardHeader breadcrumb="Data Master / Wilayah / Provinsi" />
          ...
          <div className="mb-6 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
            <div className="space-y-1.5">
              ...
              <p className="text-sm text-muted-foreground w-full max-w-xl leading-relaxed">
                Kelola data wilayah tingkat provinsi yang digunakan sebagai referensi
