  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
       ...
       <main className="flex-1 pt-32 pb-24 container mx-auto px-6">
         <AnimatedText as="h1" text="BERITA TERBARU" className="text-4xl md:text-6xl font-title font-bold mb-8" />
         
         <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 opacity-0 animate-[fadeIn_1s_ease_0.5s_forwards]">
            <p className="font-body text-muted-foreground">Belum ada berita terbaru saat ini.</p>
         </div>
       </main>
