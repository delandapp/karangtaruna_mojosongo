...
export async function seedOrganisasi(prisma: PrismaClient) {
    ...
    if (!provinsi || !kota || !kecamatan || !kelurahan) {
        console.warn("⚠️ Data wilayah (Jawa Tengah, Surakarta, Jebres, Mojosongo) tidak lengkap di database. Melewati seed organisasi.");
        return;
    }
    ...
    const orgs = [
        {
            ...
            alamat: "FR4R+JPG, Jl. Brigjend Katamso, Mojosongo, Kec. Jebres, Kota Surakarta, Jawa Tengah 57127",
            media_sosial: {
